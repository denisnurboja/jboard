...
class JobApplicationsControllerTest < ActionController::TestCase
  ...
  test "should create job_application" do
    assert_difference('JobApplication.count') do
      post :create, job_application: { cover_letter: @job_application.cover_letter, job_id: @job_application.job_id, name: @job_application.name, resume: @job_application.resume }
    end
  ...
  test "should update job_application" do
    patch :update, id: @job_application, job_application: { cover_letter: @job_application.cover_letter, job_id: @job_application.job_id, name: @job_application.name, resume: @job_application.resume }
    assert_redirected_to job_application_path(assigns(:job_application))
  end
